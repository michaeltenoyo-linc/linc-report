        ...
        <form id="loa-generate-report" class="relative w-full" autocomplete="off">
            ...
            <div class="w-full grid grid-cols-2 gap-4">
                <div class="flex inline-block w-full mb-5">
                    <input name="archive_checkbox" id="archive-checkbox" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="archive-checkbox" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Archived</label>
                </div>
