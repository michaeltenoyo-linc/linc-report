...
<div class="w-full mb-12 px-4">
    <div class="relative flex flex-col min-w-0 overflow-x-auto break-words w-full mb-6 shadow-lg rounded bg-white">
        <div class="block w-full p-8 overflow-x-auto">
            <!-- Projects table -->
            <table id="yajra-datatable-monitoring-budget" style="width: 1800px;" class="items-center w-full bg-transparent border-collapse yajra-datatable-monitoring-budget">
            <thead>
                <tr>
