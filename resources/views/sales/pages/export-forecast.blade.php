    ...
    <div class="relative flex flex-col min-w-0 overflow-x-auto break-words w-full mb-6 shadow-lg rounded bg-white">
        <div class="block w-full p-8 overflow-x-auto">
            <div class="w-full text-center">
                <span class="text-xl font-bold">Sales Forecast Rolling</span>
            </div>

            <div class="w-full grid grid-cols-3 gap-4 mb-3">
                <div class="relative mb-4 mt-4">
                    <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2"
                            htmlFor="date-filter">START PERIOD</label>
                    <input 
                        type="month" 
                ...
                <div class="relative mb-4 mt-4">
                    <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2"
                            htmlFor="date-filter">END ACTUAL</label>
                    <input 
                        type="month" 
                        class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                        id="end-filter"
                ...
                <div class="relative mb-4 mt-4">
                    <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2"
                            htmlFor="date-filter">FORECAST RANGE</label>
                    <input 
                        type="month" 
                        class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                        id="date-filter"
            ...
            <div class="w-full mb-8 mt-4">
                <form id="form-export-forecast" autocomplete="off">
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            ...
                            <div>
                                <div class="flex flex-row-reverse w-full mb-3">
                                    <input type="submit"
                                        class="export-forecast-download bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-2 rounded text-right"
                                        value="Export"/>
                                </div>
                            </div>
                        </div>
