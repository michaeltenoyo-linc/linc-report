...
class LoadPerformanceSeeder extends Seeder
{
    /**
        ...
        while(($data = fgetcsv($csvFile, 0, ',','"')) != FALSE){
            ...
            if (!$firstline){
                LoadPerformance::create([
                    ...
                    'payable_total_base_rate' => $data['16'],
                    'payable_total_accessorials' => $data['17'],
                    'payable_total_rate' => $data['18'],
                    'billable_total_rate' => $data['19'],
                    ...
                    'first_routing_guide_carrier_base_rate' => $data['58'],
